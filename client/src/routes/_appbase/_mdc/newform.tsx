...
export const Route = createFileRoute('/_appbase/_mdc/newform')({
    component: NewForm,
})
        ...
        <>
            <Stack gap={1}>
                ...
                <form onSubmit={handleSubmit}>
                    <Stack gap={3}>
                        <FormControl>
                            <FormLabel>Choose collection to add to:</FormLabel>
                            <Select placeholder="Select a collection" name="collId" required>
                            ...
                            <FormHelperText>$TODO helper text collId</FormHelperText>
                        </FormControl>
                        <FormControl>
                            ...
                            />
                            <FormHelperText>$TODO helper text barcode</FormHelperText>
                        </FormControl>
